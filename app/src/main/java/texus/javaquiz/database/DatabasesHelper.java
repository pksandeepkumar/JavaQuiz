...
package texus.javaquiz.database;
...
import sbl.kilban.model.Area;
import sbl.kilban.model.Distributor;
import sbl.kilban.model.ProductCategory;
import sbl.kilban.model.ProductItem;
import sbl.kilban.model.Route;
import sbl.kilban.model.SalesOfficer;
import sbl.kilban.model.Shop;
import sbl.kilban.model.TourPlan;
import sbl.kilban.model.TravelExpense;
import sbl.kilban.model.secondary.OrderDetails;
import sbl.kilban.model.secondary.OrderInfo;
...
//				LOG.log("Query:", "Query:" + query);
	...
	private void loadQuery() {
		...
		query_create_tables.add(Area.CREATE_TABLE_QUERY);
